...
- **Agent loop** — `agent.py` with Claude API tool loop, 24 tool definitions, vision support (base64 image content blocks), Swedish system prompt with image workflow guidance.
